...
@section('header')
    <div class="layui-inline">
        <div class="layui-btn layui-btn-sm layui-btn-warm hidden-xs fresh" fresh-url="{{url('/logs')}}"><i class="layui-icon layui-icon-refresh-3"></i></div>
    </div>
    <div class="layui-inline">
    ...
    <div class="layui-inline">
        <input class="layui-input" name="begin" placeholder="开始日期" onclick="layui.laydate.render({elem: this, festival: true})" value="{{ $input['begin'] ?? '' }}">
    </div>
    <div class="layui-inline">
