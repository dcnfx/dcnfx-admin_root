    ...
    <table class="layui-table" lay-skin="line">
        ...
        @foreach($menus as $branch)
            <tr id='node-{{$branch['id']}}' class="parent collapsed">
                ...
                <td class="hidden-xs"><input type="number" name="title" autocomplete="off" class="layui-input" value="{{$branch['order']}}" data-id="{{$branch['id']}}" data-url="{{route('sort')}}" onchange="changeSort('menus',this)"></td>
            ...
            @if(isset($branch['children']))
                @foreach ($branch['children'] as $child_branch)
                    <tr id='node-{{$branch['id']}}' class="child-node-{{$branch['id']}} parent collapsed" style="display:none ;" parentid="{{$branch['id']}}">
                        ...
                        <td class="hidden-xs"><input type="text" name="title" autocomplete="off" class="layui-input" value="{{$child_branch['order']}}" data-id="{{$child_branch['id']}}" data-url="{{route('sort')}}" onchange="changeSort('menus',this)"></td>
